    ...
    render() {
        ...
        const display = questions.length === 0 ? (
            <div className="cannt-find">
                <img className="img-reference" src="https://cdn.sstatic.net/Img/magnifying.svg?v=f06250fb4fbb"/>
                <div className="first-sentence">We couldn't find anything for <span className="query-text">{query}</span>!</div>
                <div className="second-section">Try different or less specific keywords.</div>
            </div>
        ) : (
                <ul>
                    {
                               ...
                               >
                                <div className="question-search-list">
                                     <div className="search-count-section">
                                        <div className="search-num-lengh">{question.answerIds.length}</div>
                                        <div className="search-num-answers">answers</div>
                                     </div>
                                     <div>
                                         <div className="search-title">Q: {question.title}</div>
                                         <div className="search-body">{question.body}</div>
                                     </div>
                                </div>
                            </li>
                        ))
        ...
        const main= (url === '/search/' ? (
            <div className="search-outer">
                <div className="home-section" onClick={() => this.routeChange("/")}><div className="home-home">Home</div></div>
            ...
            <div className="search-outer">
                ...
                <div className="question-search-page">
                    ...
                    <div className="number-results">{questions.length} results</div>
                    <div className="top-border"></div>
                   <div>{display}</div>
                </div>
            </div>
